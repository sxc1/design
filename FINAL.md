# SXC1 Finalization Checklist

Use this checklist to lock in final semantic assignments for both modes.

## Light Mode

### Surface
- [x] Background (`background`) — palette: `neutral` shade: `50`
- [x] Foreground (`foreground`) — palette: `neutral` shade: `900`
- [x] Card (`card`) — palette: `neutral` shade: `50`
- [x] Card Foreground (`card-foreground`) — palette: `neutral` shade: `900`
...
- [x] Secondary Foreground (`secondary-foreground`) — palette: `inkBlack` shade: `900`

### Muted
- [x] Muted (`muted`) — palette: `neutral` shade: `100`
- [x] Muted Foreground (`muted-foreground`) — palette: `inkBlack` shade: `600`

### Accent
- [x] Accent (`accent`) — palette: `exp-9` shade: `100`
- [x] Accent Foreground (`accent-foreground`) — palette: `exp-9` shade: `900`
...
- [x] Input (`input`) — palette: `inkBlack` shade: `200`
...
### Surface
- [x] Background (`background`) — palette: `neutral` shade: `950`
- [x] Foreground (`foreground`) — palette: `neutral` shade: `50`
- [x] Card (`card`) — palette: `neutral` shade: `900`
